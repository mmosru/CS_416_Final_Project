...
class SpeciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create species" do
    assert_difference('Species.count') do
      post species_index_url, params: { species: { common_name: @species.common_name, description: @species.description, generic_name: @species.generic_name, specific_name: @species.specific_name } }
    end
  ...
  test "should update species" do
    patch species_url(@species), params: { species: { common_name: @species.common_name, description: @species.description, generic_name: @species.generic_name, specific_name: @species.specific_name } }
